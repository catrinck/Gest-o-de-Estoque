...
router.post('/', async (req, res) => {
    try {
        const { name, description, type, current_quantity, minimum_quantity, supplier_name } = req.body;

        if (!name || !description || !type || current_quantity === undefined || minimum_quantity === undefined || !supplier_name) {
        ...
        const [result] = await db.query(
            ...
            [name, description, type, current_quantity, minimum_quantity, supplier_name]
        );
